...
// Recursively find the tree height
...
// Print a 2D Tree with some formatting
...
// Wrapper for other print function
...
int main(int argc, char *argv[]) {
  ...
  insertFile.close();
  // Print tree height and the tree
